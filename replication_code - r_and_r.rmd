...
6.8 Alternative model specification
...
## Country-fixed and TWFE 

```{r country-TWFE effects}

#-------------------------------------------------------------------------------
# Model group 1 
#-------------------------------------------------------------------------------
m3_cf <- lm(log_cc_outs ~ vdem_polyarchy + log_pop + log_gdp_pc + log_gdp_pc_sq + as.factor(ccode), data = data_ova)
...
# Model group 2 
#-------------------------------------------------------------------------------
m8_cf <- lm(log_ghg_pc ~ log_cc_outs + vdem_polyarchy + log_cc_outs*vdem_polyarchy +
             log_pop + log_gdp_pc + log_gdp_pc_sq + as.factor(ccode),
             data = data_ova)
