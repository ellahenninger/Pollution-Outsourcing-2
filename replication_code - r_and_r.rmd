...
## Exclusively negative (even though not )
results_df2$low_CI <- results_df2$coefficient.Estimate - 1.96*results_df2$se.Std..Error
results_df2$high_CI <- results_df2$coefficient.Estimate + 1.96*results_df2$se.Std..Error
