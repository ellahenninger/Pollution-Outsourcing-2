...
# 
# modelplot(m3_wb, 
#           coef_map = c("demeaned_log_gdp_pc_sq" = "GDP per capita$^2$",
...
# 
# modelplot(m3_wb, 
#           coef_map = c("mean_log_gdp_pc_sq" = "GDP per capita$^2$",
...
# base_plot <-
#   plot_cme(m8_wb,
#          variables = "demeaned_log_cc_outs",
#          condition = "mean_vdem_poly",
#          conf_level = 0.95) +
# theme_bw() +
...
segments(y0 = 1, x0 = CI_FD_dem_low_b[1],
         y1 = 1, x1 = CI_FD_dem_low_b[2],
         col = viridis(3, alpha = 0.3)[2],
         lwd = 12, cex = 1.5, lend = 1)

segments(y0 = 2, x0 = CI_FD_dem_high_b[1],
         y1 = 2, x1 = CI_FD_dem_high_b[2],
         col = viridis(3)[2],
         lwd = 12, cex = 1.5, lend = 1)
